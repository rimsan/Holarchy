...
// Holarchy
#define COCOAPODS_POD_AVAILABLE_Holarchy
#define COCOAPODS_VERSION_MAJOR_Holarchy 0
#define COCOAPODS_VERSION_MINOR_Holarchy 1
#define COCOAPODS_VERSION_PATCH_Holarchy 0
